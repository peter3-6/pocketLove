...
Page({
  ...
  onLoad: function () {
    ...
    // app.getUserInfo(function (userInfo) {
      //更新数据
      that.setData({
        userInfo: "https://koudaizhilian-1254460722.cosbj.myqcloud.com/images/gender1.jpg",
      })
    // })
    wx.getSystemInfo({
  ...
  onReady: function (e) {
    ...
    app.menuConfig = {
      menu: [
        { 'index': 0, 'menu': '惠小米', 'src': '../images/account.png' },
        { 'index': 1, 'menu': '男', 'src': '../images/card.png' },
        // { 'index': 2, 'menu': '河南省', 'src': '../images/investment.png' },
        { 'index': 3, 'menu': '双鱼座', 'src': '/images/constellation.png' },
        { 'index': 4, 'menu': '签名', 'src': '../images/service.png' },
        { 'index': 5, 'menu': '中国人民解放军防化指挥工程学院', 'src': '../images/transfer.png' }
      ]
    }
    // 绘制转盘
